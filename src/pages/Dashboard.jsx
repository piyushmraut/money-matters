...
//                   <td className="px-6 py-4">Spotify Subscription</td>
//                   <td className="px-6 py-4">Shopping</td>
//                   <td className="px-6 py-4">28 Jan, 12.30 AM</td>
//                   <td className="px-6 py-4 text-red-500">-$150</td>
...
//                 </tr>
//                 <tr className="border-t">
//                   <td className="px-6 py-4">Mobile Service</td>
//                   <td className="px-6 py-4">Service</td>
//                   <td className="px-6 py-4">25 Jan, 10.40 PM</td>
//                   <td className="px-6 py-4 text-red-500">-$150</td>
//                   <td className="px-6 py-4 flex items-center space-x-2">
//                     <FaEdit className="text-blue-500 cursor-pointer" />
//                     <FaTrash className="text-red-500 cursor-pointer" />
...
//                 </tr>
//                 <tr className="border-t">
//                   <td className="px-6 py-4">Emily Wilson</td>
//                   <td className="px-6 py-4">Transfer</td>
//                   <td className="px-6 py-4">20 Jan, 10.40 PM</td>
//                   <td className="px-6 py-4 text-green-500">+$780</td>
//                   <td className="px-6 py-4 flex items-center space-x-2">
//                     <FaEdit className="text-blue-500 cursor-pointer" />
//                     <FaTrash className="text-red-500 cursor-pointer" />
//                   </td>
...
const Dashboard = () => {
  ...
  // Modern graph data configuration
  const updatedGraphData = {
    labels: graphData.labels,
    datasets: graphData.datasets.map(dataset => {
      if (dataset.label === 'Credit') {
        return {
          ...dataset,
          label: 'Credit',
          ...
          borderRadius: 8,
          borderSkipped: false,
          hoverBackgroundColor: '#FFB16D',
          hoverBorderColor: '#FFB16D',
          barPercentage: 0.7,
        ...
        return {
          ...
          borderRadius: 8,
          borderSkipped: false,
          hoverBackgroundColor: '#5B9BF5',
          hoverBorderColor: '#5B9BF5',
          barPercentage: 0.7,
          categoryPercentage: 0.8
        };
      }
    ...
    <div className="flex">
      ...
      <div className="flex-1 ml-64 min-h-screen">
        ...
        <motion.div 
          ...
          className="flex justify-between items-center mb-6 bg-white p-4 shadow"
        >
          <h1 className="text-3xl font-bold text-gray-800">Accounts</h1>
          <button 
            onClick={() => setShowAddForm(true)}
            className="bg-blue-600 text-white px-4 py-2 rounded-2xl hover:bg-blue-700 transition-all duration-300 transform hover:scale-105"
          >
            + Add Transaction
          </button>
        </motion.div>
         ...
         <div className="p-8 bg-gray-50">
          ...
          >
            ...
            >
              <div>
                <p className="text-sm text-gray-500">Credit</p>
                <p className="text-3xl font-bold text-green-500">${totals.credit || 0}</p>
              </div>
            ...
            >
              <div>
                <p className="text-sm text-gray-500">Debit</p>
                <p className="text-3xl font-bold text-red-500">${totals.debit || 0}</p>
              </div>
          ...
          >
            <h2 className="text-lg font-semibold text-gray-700 mb-4">Last Transaction</h2>
              ...
              <table className="w-full text-left">
                ...
                <tbody className="text-gray-700">
                  {transactions.slice(0, 3).map((transaction, index) => (
                    ...
                    >
                      <td className="px-6 py-4">{transaction.transaction_name}</td>
                      <td className="px-6 py-4">
                        <span className={`px-2 py-1 rounded-full text-xs ${transaction.type === 'credit' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                          {transaction.type}
                        </span>
                      </td>
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-semibold text-gray-700">Debit & Credit Overview</h2>
            ...
            <p className="text-sm text-gray-500 mb-4">
              ${totals.debit || 0} Debited & ${totals.credit || 0} Credited in this Week
            </p>
