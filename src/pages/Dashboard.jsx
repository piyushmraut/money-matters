...
//               ${totals.debit || 0} Debited & ${totals.credit || 0} Credited in
//               this Week
//             </p>
//             <div className="h-96 w-full">
//               <Bar data={updatedGraphData} options={options} />
//             </div>
//           </motion.div>
//         </div>
//       </div>
    ...
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="flex-1 md:ml-64 min-h-screen">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="flex flex-col md:flex-row justify-between items-center mb-6 bg-white p-4 shadow"
        >
          ...
          <button
            onClick={() => setShowAddForm(true)}
            className="bg-blue-600 text-white px-4 py-2 rounded-2xl hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 w-full md:w-auto text-sm md:text-base"
          >
            + Add Transaction
          </button>
        </motion.div>
                      ...
                      {transactions
                        ...
                        .map((transaction, index) => (
                          ...
                          >
                            ...
                            <td
                              className={`px-4 md:px-6 py-4 whitespace-nowrap text-sm font-medium ${
                                transaction.type === "credit"
                                  ? "text-green-700"
                                  : "text-red-700"
                              }`}
